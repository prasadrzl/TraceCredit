...
const HOW_STEPS = [
  { icon: "🗂️", title: "Connect wallet", sub: "Link your existing EVM wallet" },
  {
    icon: "🪙",
    title: "Mint your SBT",
    sub: "Lock 50 USDC · get on-chain identity",
  },
  {
    icon: "⭐",
    title: "Build reputation",
    sub: "Repay loans · vote · hold assets",
  },
...
export function StepLanding({ onGetStarted }: Props) {
  return (
    <div
      ...
      style={{ background: "#0E0E12", color: "#fff" }}
    >
      {/* Top nav */}
      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center px-4 py-20 max-w-3xl mx-auto w-full">
        ...
        <div
          ...
          style={{
            ...
            border: "0.5px solid rgba(124,109,219,0.4)",
          }}
        >
        ...
        >
          Your on-chain history is your credit score. Repay loans, vote in DAOs,
          hold assets — and unlock a revolving credit line proportional to your
          reputation.
        </p>
          ...
          {HOW_STEPS.map((step) => (
            ...
            >
              <span
                ...
                style={{
                  background: "rgba(124,109,219,0.15)",
                  border: "0.5px solid rgba(124,109,219,0.25)",
                }}
              >
                {step.icon}
              </span>
